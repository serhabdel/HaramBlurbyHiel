...
// Islamic-inspired font family - using fallback to system fonts if custom font not available
val ReemKufiFontFamily = try {
    FontFamily(
...
val PrimaryFontFamily = ReemKufiFontFamily

// Enhanced Typography with Islamic-inspired styling
val Typography = Typography(
    // Display styles for hero text - used for major headers
